...
INSERT INTO `topic` (`topic_id`, `author_id`, `title`, `last_post`, `topic_content`) VALUES (1, 1, 'Start', 1, 'Server startup');
INSERT INTO `topic` (`topic_id`, `author_id`, `title`, `last_post`, `topic_content`) VALUES (2, 1, 'Problems', 2, 'Problems');
...
INSERT INTO `posts` (`post_id`, `author_id`, `topic_id`, `post_time`, `text`) VALUES (1, 1, 1, default, 'Server is running. Please get familiar with it.');
INSERT INTO `posts` (`post_id`, `author_id`, `topic_id`, `post_time`, `text`) VALUES (2, 1, 2, default, 'All problems should be posted here');
